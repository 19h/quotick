...
fn canonical_codes_scales_and_definition_identity_are_validated() {
    ...
    let invalid_spec = InstrumentSpec {
        ...
        reserve: invalid.reserve_order_rules(),
        hidden_orders_supported: invalid.hidden_orders_supported(),
...
fn first_spec(definition: InstrumentDefinition) -> InstrumentSpec {
    ...
    InstrumentSpec {
        ...
        reserve: definition.reserve_order_rules(),
        hidden_orders_supported: definition.hidden_orders_supported(),
