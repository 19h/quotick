...
bands, exact selected-row materialization, and hidden-only exclusion. BBO tests
cover empty, one-sided, hidden-only, and two-sided public state; instrument/
