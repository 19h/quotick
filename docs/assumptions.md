...
- **High impact:** local command/event recovery, canonical-path writer exclusion,
  ...
  replication, and durable state snapshots remain prerequisites for bounded
  production recovery claims.
